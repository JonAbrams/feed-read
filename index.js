    ...
    callback(null, _.filter(_.map(articles,
      function(art) {
        ...
        var obj = {
          ...
          , feed:      meta
          , length:    child_by_name(art, 'enclosure') && child_by_name(art, 'enclosure').attributes.length
          };
    ...
    callback(null, _.filter(_.map(articles,
      function(art) {
        ...
        var obj = {
          ...
          , feed:      meta
          , length:    child_by_name(art, 'enclosure') && child_by_name(art, 'enclosure').attributes.length
          , url:       child_by_name(art, 'enclosure') && child_by_name(art, 'enclosure').attributes.url
          };
        if (obj.published) obj.published = new Date(obj.published);
        return obj;
      }
